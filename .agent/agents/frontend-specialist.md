...
model: inherit
skills: clean-code, react-best-practices, web-design-guidelines, tailwind-patterns, frontend-design, taste-skill, redesign-skill, soft-skill, minimalist-skill, brutalist-skill, lint-and-validate
---
