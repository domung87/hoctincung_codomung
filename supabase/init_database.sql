...
-- 7. BẢNG LỊCH SỬ LÀM QUIZ (QUIZ RESULTS)
...
VALUES 
    ...
    ('admin-quan-tri', 'admin@tinhoc6.edu.vn', 'Quản Trị Viên Hệ Thống', 'admin', 'Ban Giám Hiệu', 'admin', 'admin123', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150', 'Quản trị viên Hệ thống Cùng Học Tin 6', 5000, 15, 2000, 45)
...
VALUES 
    (
        ...
        'Bài 1: Thông tin và dữ liệu (Máy tính & các thành phần cơ bản)', 15, 
    ...
    ('lesson-2', 'topic-a', 'A', 2, 'Bài 2: Xử lý thông tin & Rèn luyện kỹ năng sử dụng chuột', 20, 'Quy trình xử lý thông tin 4 bước và 5 thao tác cơ bản với chuột máy tính.', '["Quy trình 4 bước: Thu nhận -> Lưu trữ -> Xử lý -> Truyền thông tin.", "5 thao tác chuột: Di chuyển, Nháy chuột (Click), Nháy đúp, Nháy phải, Kéo thả."]'::jsonb, '[]'::jsonb),
    ('lesson-3', 'topic-a', 'A', 3, 'Bài 3: Máy tính trong hoạt động thông tin & Soạn thảo cơ bản', 25, 'Máy tính hỗ trợ con người trong thu nhận, lưu trữ, xử lý và truyền đạt thông tin.', '["Máy tính tính toán nhanh, chính xác và lưu trữ khổng lồ.", "Máy tính chưa thể có cảm xúc và trực giác như con người."]'::jsonb, '[]'::jsonb),
    ('lesson-4', 'topic-a', 'A', 4, 'Bài 4: Biểu diễn văn bản, hình ảnh, âm thanh trong máy tính', 25, 'Dãy bit 0 và 1 - Ngôn ngữ nhị phân; Các đơn vị đo dung lượng Byte, KB, MB, GB.', '["Mọi thông tin trong máy tính đều biểu diễn bằng dãy bit (0 và 1).", "1 Byte (B) = 8 bit. 1 KB = 1024 B. 1 MB = 1024 KB. 1 GB = 1024 MB."]'::jsonb, '[]'::jsonb),
    ('lesson-5', 'topic-b', 'B', 5, 'Bài 5: Mạng máy tính', 20, 'Khái niệm mạng máy tính, thành phần mạng và lợi ích chia sẻ tài nguyên.', '["Mạng máy tính giúp trao đổi thông tin và chia sẻ tài nguyên.", "Thành phần gồm: Thiết bị đầu cuối, Thiết bị kết nối, Phần mềm mạng."]'::jsonb, '[]'::jsonb),
    ('lesson-6', 'topic-b', 'B', 6, 'Bài 6: Mạng thông tin toàn cầu (Internet & WWW)', 20, 'World Wide Web (WWW), website, trình duyệt web và siêu liên kết.', '["Internet là mạng liên kết toàn cầu.", "WWW là mạng thông tin gồm các trang web liên kết bằng siêu văn bản."]'::jsonb, '[]'::jsonb),
    ('lesson-10', 'topic-d', 'D', 10, 'Bài 10: Sơ đồ tư duy (Mindmap)', 20, 'Phương pháp tóm tắt kiến thức bằng từ khóa, hình ảnh và các nhánh nối liên kết.', '["Chủ đề chính ở trung tâm, ý chính là nhánh lớn, ý phụ là nhánh nhỏ.", "Giúp ghi nhớ bài học nhanh và có hệ thống."]'::jsonb, '[]'::jsonb),
    ('lesson-13', 'topic-f', 'F', 13, 'Bài 13: Thuật toán và các cách mô tả thuật toán', 25, 'Thuật toán là dãy các chỉ dẫn từng bước rõ ràng để giải quyết bài toán.', '["Mô tả bằng lời văn tự nhiên và Vẽ sơ đồ khối (Flowchart).", "Đầu vào (Input) -> Các bước xử lý -> Đầu ra (Output)."]'::jsonb, '[]'::jsonb)
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.questions (id, lesson_id, question_text, options, correct_answer, explanation, points, tag)
VALUES 
    ('q-tin6-1', 'lesson-1', 'Thành phần nào được xem là "Bộ não" của máy tính, có nhiệm vụ xử lý thông tin và tính toán?', '["Bộ xử lý trung tâm (CPU - Thân máy)", "Bàn phím (Keyboard)", "Màn hình máy tính (Monitor)", "Chuột máy tính (Mouse)"]'::jsonb, 'Bộ xử lý trung tâm (CPU - Thân máy)', 'Thân máy chứa CPU đóng vai trò như bộ não, thực hiện mọi phép tính toán và điều khiển hoạt động của máy tính.', 10, 'Chủ đề A - Tin 6'),
    ('q-tin6-2', 'lesson-1', 'Trong các thiết bị sau, thiết bị nào thuộc nhóm "Thiết bị vào" (Input Device)?', '["Bàn phím và Chuột máy tính", "Màn hình và Loa", "Máy in và Máy chiếu", "Tai nghe và Ổ đĩa mềm"]'::jsonb, 'Bàn phím và Chuột máy tính', 'Bàn phím và chuột giúp người dùng đưa dữ liệu và lệnh từ bên ngoài vào máy tính nên gọi là Thiết bị vào.', 10, 'Chủ đề A - Tin 6'),
    ('q-tin6-3', 'lesson-1', '1 Byte (B) bằng bao nhiêu bit trong hệ thống biểu diễn thông tin nhị phân?', '["8 bit", "10 bit", "1024 bit", "16 bit"]'::jsonb, '8 bit', '1 Byte gồm 8 bit nhị phân (gồm các chữ số 0 và 1).', 10, 'Chủ đề A - Tin 6'),
    ('q-tin6-4', 'lesson-5', 'Mạng máy tính mang lại lợi ích lớn nhất nào cho người sử dụng?', '["Chia sẻ tài nguyên, dữ liệu và trao đổi thông tin nhanh chóng", "Làm cho máy tính không bao giờ bị hỏng", "Tự động làm bài tập thay cho học sinh", "Tiết kiệm điện năng 100%"]'::jsonb, 'Chia sẻ tài nguyên, dữ liệu và trao đổi thông tin nhanh chóng', 'Mạng máy tính giúp các máy tính có thể gửi nhận tệp tin, dùng chung máy in và truyền tin tức tức thì.', 10, 'Chủ đề B - Tin 6'),
    ('q-tin6-5', 'lesson-13', 'Thuật toán trong Tin học được hiểu là gì?', '["Dãy các chỉ dẫn từng bước rõ ràng, có thứ tự để giải quyết một công việc", "Một loại virus máy tính", "Tên gọi của chiếc máy tính đầu tiên", "Một bài văn tả cảnh thiên nhiên"]'::jsonb, 'Dãy các chỉ dẫn từng bước rõ ràng, có thứ tự để giải quyết một công việc', 'Thuật toán là các bước cụ thể, tuần tự từ dữ liệu đầu vào (Input) để tạo ra kết quả mong muốn (Output).', 10, 'Chủ đề F - Tin 6')
ON CONFLICT (id) DO NOTHING;

INSERT INTO public.assignments (id, lesson_id, title, description, due_date, max_score, rubric)
VALUES 
    ('assign-tin6-1', 'lesson-1', 'Bài tập: Phân loại các thiết bị phần cứng máy tính quanh em', 'Em hãy kể tên 3 thiết bị vào, 3 thiết bị ra và 2 thiết bị lưu trữ thông tin mà em thường thấy ở phòng thực hành Tin học hoặc tại nhà.', NOW() + INTERVAL '14 days', 100, '[{"criteria": "Kể đúng 3 thiết bị vào", "points": 40}, {"criteria": "Kể đúng 3 thiết bị ra", "points": 40}, {"criteria": "Kể đúng 2 thiết bị lưu trữ", "points": 20}]'::jsonb)
ON CONFLICT (id) DO NOTHING;
